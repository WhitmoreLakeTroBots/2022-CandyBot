...
public class SubDriveTrain extends SubsystemBase {
    ...
    public SubDriveTrain() {
        ...
        TalonSRX_driveLeft_1.setInverted(false);
        TalonSRX_driveLeft_2.setInverted(false);
        TalonSRX_driveRight_1.setInverted(true);
        TalonSRX_driveRight_2.setInverted(true);
